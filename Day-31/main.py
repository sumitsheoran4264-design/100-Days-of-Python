...
def next_card():
    ...
    canvas.itemconfig(card_background, image=card_fornt_img)
...
card_fornt_img = PhotoImage(file="Day-31/images/card_front.png")
card_back_img = PhotoImage(file="Day-31/images/card_back.png")

card_background = canvas.create_image(400, 263, image=card_fornt_img)
...
right_tick_image = PhotoImage(file="Day-31/images/right.png")
